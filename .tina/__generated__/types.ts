...
export type Query = {
  ...
  convenios: Convenios;
  conveniosConnection: ConveniosConnection;
};
...
export type QueryConveniosArgs = {
  relativePath?: InputMaybe<Scalars['String']['input']>;
};


export type QueryConveniosConnectionArgs = {
  before?: InputMaybe<Scalars['String']['input']>;
  after?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Float']['input']>;
  last?: InputMaybe<Scalars['Float']['input']>;
  sort?: InputMaybe<Scalars['String']['input']>;
  filter?: InputMaybe<ConveniosFilter>;
};

export type DocumentFilter = {
  blog?: InputMaybe<BlogFilter>;
  convenios?: InputMaybe<ConveniosFilter>;
};
...
export type DocumentNode = Blog | Convenios | Folder;
...
export type ConveniosConnectionEdges = {
  __typename?: 'ConveniosConnectionEdges';
  cursor: Scalars['String']['output'];
  node?: Maybe<Convenios>;
};

export type ConveniosConnection = Connection & {
  __typename?: 'ConveniosConnection';
  pageInfo: PageInfo;
  totalCount: Scalars['Float']['output'];
  edges?: Maybe<Array<Maybe<ConveniosConnectionEdges>>>;
};
...
export type Mutation = {
  ...
  updateBlog: Blog;
  createBlog: Blog;
  updateConvenios: Convenios;
  createConvenios: Convenios;
};
...
export type MutationUpdateConveniosArgs = {
  relativePath: Scalars['String']['input'];
  params: ConveniosMutation;
};


export type MutationCreateConveniosArgs = {
  relativePath: Scalars['String']['input'];
  params: ConveniosMutation;
};
...
export type DocumentUpdateMutation = {
  ...
  convenios?: InputMaybe<ConveniosMutation>;
  relativePath?: InputMaybe<Scalars['String']['input']>;
};
...
export type BlogQuery = { __typename?: 'Query', blog: { __typename: 'Blog', id: string, title: string, description?: string | null, author?: string | null, date?: string | null, topics?: Array<string | null> | null, featuredImage?: string | null, featured?: boolean | null, body?: string | null, _sys: { __typename?: 'SystemInfo', filename: string, basename: string, breadcrumbs: Array<string>, path: string, relativePath: string, extension: string } } };
...
export type BlogConnectionQuery = { __typename?: 'Query', blogConnection: { __typename?: 'BlogConnection', totalCount: number, pageInfo: { __typename?: 'PageInfo', hasPreviousPage: boolean, hasNextPage: boolean, startCursor: string, endCursor: string }, edges?: Array<{ __typename?: 'BlogConnectionEdges', cursor: string, node?: { __typename: 'Blog', id: string, title: string, description?: string | null, author?: string | null, date?: string | null, topics?: Array<string | null> | null, featuredImage?: string | null, featured?: boolean | null, body?: string | null, _sys: { __typename?: 'SystemInfo', filename: string, basename: string, breadcrumbs: Array<string>, path: string, relativePath: string, extension: string } } | null } | null> | null } };

export type ConveniosQueryVariables = Exact<{
  relativePath: Scalars['String']['input'];
}>;
...
export const BlogConnectionDocument = gql`
  ...
  blogConnection(
    ...
    ${BlogPartsFragmentDoc}`;
export const ConveniosDocument = gql`
    query convenios($relativePath: String!) {
  convenios(relativePath: $relativePath) {
    ... on Document {
      _sys {
        filename
        basename
    ...
    ${ConveniosPartsFragmentDoc}`;
export const ConveniosConnectionDocument = gql`
    query conveniosConnection($before: String, $after: String, $first: Float, $last: Float, $sort: String, $filter: ConveniosFilter) {
  conveniosConnection(
    before: $before
    after: $after
    first: $first
...
export type Requester<C= {}> = <R, V>(doc: DocumentNode, vars?: V, options?: C) => Promise<R>
  export function getSdk<C>(requester: Requester<C>) {
    ...
    convenios(variables: ConveniosQueryVariables, options?: C): Promise<{data: ConveniosQuery, errors?: { message: string, locations: { line: number, column: number }[], path: string[] }[], variables: ConveniosQueryVariables, query: string}> {
        return requester<{data: ConveniosQuery, errors?: { message: string, locations: { line: number, column: number }[], path: string[] }[], variables: ConveniosQueryVariables, query: string}, ConveniosQueryVariables>(ConveniosDocument, variables, options);
      },
    conveniosConnection(variables?: ConveniosConnectionQueryVariables, options?: C): Promise<{data: ConveniosConnectionQuery, errors?: { message: string, locations: { line: number, column: number }[], path: string[] }[], variables: ConveniosConnectionQueryVariables, query: string}> {
        return requester<{data: ConveniosConnectionQuery, errors?: { message: string, locations: { line: number, column: number }[], path: string[] }[], variables: ConveniosConnectionQueryVariables, query: string}, ConveniosConnectionQueryVariables>(ConveniosConnectionDocument, variables, options);
      }
    };
  }
