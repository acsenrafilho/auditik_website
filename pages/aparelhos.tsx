...
export default function AparelhosPage() {
  const seo = getSEOMeta({
    ...
    description: 'Conheça nossa linha completa de aparelhos auditivos Philips HearLink. Tecnologia de IA avançada, discrição total e ajuste personalizado. Avaliação gratuita.',
  });
      ...
      <main>
          ...
          <div className="container-wide">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="p-8 bg-bg-light-blue rounded-2xl">
                <h3>HearLink 500</h3>
                <p className="text-gray-600 mt-4">
                  Modelo intermediário com conectividade avançada. Controle por smartphone.
                </p>
                <p className="text-auditik-blue font-bold mt-4">Consulte</p>
              </div>
              <div className="p-8 bg-bg-light-blue rounded-2xl">
        ...
        <section className="page-section">
          <div className="container-wide text-center">
            ...
            <p className="text-lg text-gray-600 mt-4">Agende uma avaliação gratuita e descubra o dispositivo perfeito para você.</p>
